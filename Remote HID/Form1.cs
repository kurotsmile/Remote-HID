    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            if (this.settings.actItems.Count == 0)
            {
                ...
                this.settings.actItems.Add(new Act_item { name = "Screen", func = "OpenProjectMenu",index_icon=10});
                this.settings.actItems.Add(new Act_item { name = "Notification", func = "OpenActionCenter", index_icon = 11});
                this.settings.actItems.Add(new Act_item { name = "Email", cmd = "https://mail.google.com/", index_icon = 12 });
                this.settings.actItems.Add(new Act_item { name = "Wifi", cmd = "ms-settings:network-wifi", index_icon = 13 });
                this.settings.actItems.Add(new Act_item { name = "Bluetooth", cmd = "settings:bluetooth", index_icon = 14});
                this.settings.actItems.Add(new Act_item { name = "Keyboard", cmd = "osk.exe", index_icon =15 });
                this.settings.actItems.Add(new Act_item { name = "Command", func = "Change_status_voice_command",state=1,index_icon=16});
                this.settings.actItems.Add(new Act_item { name = "Mission", cmd = @"J:\Rewards_mission\start.bat",index_icon = 17});
                this.settings.actItems.Add(new Act_item { name = "Unity", cmd = @"D:\Unity3d\Unity Hub\Unity Hub.exe",index_icon = 18});
                this.settings.actItems.Add(new Act_item { name = "Device", cmd = "devmgmt.msc", index_icon = 19});
                this.settings.actItems.Add(new Act_item { name = "Note", cmd = @"C:\Windows\System32\notepad.exe", index_icon = 30 });
                this.settings.actItems.Add(new Act_item { name = "Calculator", cmd = "calc", index_icon = 21 });
                this.settings.actItems.Add(new Act_item { name = "Translate", cmd = "https://translate.google.com/?sl=vi&tl=en&op=translate",index_icon=22});
                this.settings.actItems.Add(new Act_item { name = "Devloper", cmd = "code",index_icon=23});
                this.settings.actItems.Add(new Act_item { name = "Location", cmd = "https://maps.google.com/",index_icon=24});
                this.settings.actItems.Add(new Act_item { name = "Design", cmd = @"J:\Program Files\a\RWPaint.exe", index_icon=25});
                this.settings.actItems.Add(new Act_item { name = "Sound", cmd = "ms-settings:sound",index_icon=26});
                this.settings.actItems.Add(new Act_item { name = "Art", cmd = @"E:\Paint Tool SAI 2.0\sai2.exe", index_icon = 27 });
                this.settings.actItems.Add(new Act_item { name = "Recording", cmd = @"J:\obs-studio\bin\64bit\obs64.exe",index_icon=28});
                this.settings.actItems.Add(new Act_item { name = "Browser", cmd = "https://www.google.com/",index_icon=29});
                this.settings.actItems.Add(new Act_item { name = "Chat", cmd = "https://chatgpt.com/", index_icon=30});
                this.settings.actItems.Add(new Act_item { name = "Github", cmd = "https://github.com/kurotsmile", index_icon=31});
                this.settings.actItems.Add(new Act_item { name = "Camera", cmd = "microsoft.windows.camera:", index_icon=32});
                this.settings.actItems.Add(new Act_item { name = "Webcam", cmd = @"J:\Imou_en\bin\Imou_en.exe", index_icon=33});
                this.settings.actItems.Add(new Act_item { name = "Store", cmd = "ms-windows-store:", index_icon=34});
                this.settings.actItems.Add(new Act_item { name = "Book", cmd = @"G:\Ebook", index_icon=35});
                this.settings.actItems.Add(new Act_item { name = "Write Book", cmd = @"G:\Kindle Create\Kindle Create.exe", index_icon=36});
                this.settings.actItems.Add(new Act_item { name = "Document", cmd = "https://drive.google.com/drive/u/2/folders/1xcifsnQF-bQGystpkjphrRUlWFPPhkMw",index_icon=37});
                this.settings.actItems.Add(new Act_item { name = "Amazon Book", cmd = "https://kdp.amazon.com/en_US/bookshelf", index_icon = 38 });
                this.settings.actItems.Add(new Act_item { name = "Store Book", cmd = "https://www.amazon.com/s?i=digital-text&rh=p_27%3AThien+Thanh+Tran", index_icon = 39});
                this.settings.actItems.Add(new Act_item { name = "Play", func = "PlayPauseMedia", state = 1,index_icon=40});
                this.settings.actItems.Add(new Act_item { name = "Previous", func= "PreviousMedia", state=1,index_icon=41});
                this.settings.actItems.Add(new Act_item { name = "Next", func = "NextMedia", state = 1,index_icon=42});
                this.settings.actItems.Add(new Act_item { name = "Fast backward", func = "FastRewindMedia", state = 1,index_icon=43});
                this.settings.actItems.Add(new Act_item { name = "Fast forward", func = "FastForwardMedia", state = 1,index_icon=44});
                this.settings.actItems.Add(new Act_item { name = "Task Manager", cmd = "taskmgr", index_icon = 45});
                this.settings.actItems.Add(new Act_item { name = "Infomation", cmd = "msinfo32", index_icon = 46});
                this.settings.actItems.Add(new Act_item { name = "Uninstall", cmd = "ms-settings:appsfeatures", index_icon =47});
                this.settings.actItems.Add(new Act_item { name = "Mouse", cmd = "main.cpl", index_icon =48});
                this.settings.actItems.Add(new Act_item { name = "Service", cmd = "services.msc", index_icon = 49});
                this.settings.actItems.Add(new Act_item { name = "Update", cmd = "ms-settings:windowsupdate",index_icon=50});
                this.settings.actItems.Add(new Act_item { name = "Firewall", cmd = "wf.msc",index_icon=51});
                this.settings.actItems.Add(new Act_item { name = "web", cmd = "msedge",index_icon=52});
                this.settings.actItems.Add(new Act_item { name = "Clear", cmd = "cleanmgr",index_icon=53});
                this.settings.actItems.Add(new Act_item { name = "Disk", cmd = "diskmgmt.msc",index_icon=54});
                this.settings.actItems.Add(new Act_item { name = "Font", cmd = "control fonts",index_icon=55});
                this.settings.actItems.Add(new Act_item { name = "Zoom", cmd = "magnify",index_icon=56});
                this.settings.actItems.Add(new Act_item { name = "Music", cmd = "msmusic:",index_icon=57});
                this.settings.actItems.Add(new Act_item { name = "Telegram", cmd = "https://web.telegram.org/k/",index_icon=58});
                this.settings.actItems.Add(new Act_item { name = "Tool", cmd = "notepad++",index_icon=59});
                this.settings.actItems.Add(new Act_item { name = "Regedit", cmd = "regedit",index_icon=60});
                this.settings.actItems.Add(new Act_item { name = "cmd", cmd = "cmd", index_icon=61});
                this.settings.actItems.Add(new Act_item { name = "Photo", cmd = "ms-photos:", index_icon=62});
                this.settings.actItems.Add(new Act_item { name = "Screenshot", cmd = "snippingtool",index_icon=63});
            }
